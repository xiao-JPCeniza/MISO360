    ...
    <div class="relative min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-white">
        ...
        <div class="mx-auto flex min-h-screen w-full max-w-6xl items-center px-4 py-8 sm:px-6">
            <div class="grid w-full gap-8 lg:grid-cols-[1fr_460px] lg:gap-10">
                ...
                <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl dark:border-slate-800 dark:bg-slate-900/70 dark:shadow-2xl dark:shadow-black/40 sm:p-8">
                    <div class="flex gap-2 rounded-2xl bg-slate-100 p-1 text-sm font-semibold dark:bg-slate-950/60">
                        <button
                            type="button"
                            class="flex-1 rounded-2xl px-4 py-2.5 transition sm:py-2"
                            :class="
                                activePanel === 'signin'
                    ...
                    >
                        ...
                        <div class="flex items-center justify-between text-sm text-slate-500 dark:text-slate-400">
                            ...
                            <Link href="/" class="text-slate-600 transition hover:text-slate-900 dark:text-slate-300 dark:hover:text-white">
                                Back to home
                            </Link>
                        </div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div v-if="registerForm.email.length" class="mt-2 text-sm">
                                <span :class="emailValid ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'">
