...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $this->ensureTicketRequestAssignedStaffPivot();
    ...
    private function ensureTicketRequestAssignedStaffPivot(): void
    {
        if (! Schema::hasTable('ticket_requests') || ! Schema::hasTable('users')) {
            return;
        }
